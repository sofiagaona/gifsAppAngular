// To parse this data:
//
//   import { Convert, SearchGifsRespons } from "./file";
//
//   const searchGifsRespons = Convert.toSearchGifsRespons(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SearchGifsRespons {
    data:       Gif[]; // solo cambiamos a gif que es como luce o la interface de nuestro gif
...
export class Convert {
    public static toSearchGifsRespons(json: string): SearchGifsRespons {
        return cast(JSON.parse(json), r("SearchGifsRespons"));
    }

    public static searchGifsResponsToJson(value: SearchGifsRespons): string {
        return JSON.stringify(uncast(value, r("SearchGifsRespons")), null, 2);
    }
}
